...
export class PhotoService {
  ...
  constructor(private camera: Camera, private loaderService: LoaderService, private file: File,
  ...
  copyFileToLocalDir(namePath: string, currentName: string, newFileName: string) {
    // this.file.resolveLocalFilesystemUrl(namePath + currentName).then((entry: any) => {
    //     console.log('entry', entry);

    //     this.file.resolveLocalFilesystemUrl(this.file.dataDirectory).then((dirEntry: any) => {
